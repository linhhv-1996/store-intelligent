...
import { l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, s as sanitizeStatusCode, o as getContext, $ as $fetch, q as createHooks, r as executeAsync, h as createError$1, t as toRouteMatcher, v as createRouter$1, x as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CHnpwRvC.mjs')
  },
  {
    name: "terms",
    path: "/terms",
    component: () => import('./terms-CJUrtYcE.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import('./privacy-BwKxM7b9.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-feMerl8l.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DJE49DhD.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-zYcfwUIj.mjs'));
